...
// @title 智慧觀賞魚養殖系統
// @version 6.9
// @description Go 語言程式設計之旅：一起用 Go 做智慧觀賞魚養殖系統
// @termsOfService https://swag.live/?utm_source=webpage&utm_medium=seo&umt_campaign=24live
func main() {
...
func setupFlag() error {
	...
	flag.StringVar(&config, "config", "configs/", "指定要使用的配置檔案路徑")
